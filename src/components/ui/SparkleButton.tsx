...
const SparkleButton: React.FC<SparkleButtonProps> = ({ to, children, onClick, className }) => {
  return (
    <div className={`sp ${className || ''}`}>
      <Link to={to} className="sparkle-button" onClick={onClick}>
